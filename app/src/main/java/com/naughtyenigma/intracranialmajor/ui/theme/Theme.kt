package com.naughtyenigma.intracranialmajor.ui.theme
...
private val DarkColorPalette = IMColors(
    brand = Shadow1,
...
fun IntracranialMajorTheme(
    ...
    ProvideIMColors(colors = colors) {
        MaterialTheme(
            colors = formatColors(darkTheme),
...
fun ProvideIMColors(
    ...
    CompositionLocalProvider(LocalIMColors provides colorPalette, content = content)
}

private val LocalIMColors =
    staticCompositionLocalOf<IMColors> { error("No Intracranial Major Color Palette provided") }
